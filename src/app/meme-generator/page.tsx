  ...
  return (
    ...
    >
        ...
        <div className="flex-grow pt-10 px-4 md:px-10 bg-black/30">
            <h1 className="font-gloria text-4xl md:text-5xl font-extrabold text-center text-white drop-shadow-lg transition-all duration-300">
              CREATE YOUR OWN BEAR
            </h1>

            <div className="font-andika mt-5 max-w-5xl mx-auto">
              <Editor />
            </div>
            <Footer />
        </div>
